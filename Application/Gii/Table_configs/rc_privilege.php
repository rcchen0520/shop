...
return array(
	...
	'validate' => "
	        ...
	        array('module_name','1,10','模块名称长度不能超过30个字符',1,'length',3),
	        array('controller_name','require','控制的名称不能为空',1,'regex',3),
	        array('controller_name','1,10','控制器名称长度不能超过30个字符',1,'length',3),
	        array('action_name','1,10','方法名称长度不能超过30个字符',1,'length',3),
	        array('action_name','1,10','方法名称不能为空',1,'regex',3),
